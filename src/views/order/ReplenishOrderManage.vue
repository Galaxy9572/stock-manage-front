<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.goodsName" placeholder="请输入供应商名称或订单号"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" center>
      <el-form ref="dataForm" :rules="rules" :model="temp" label-width="80px" style="width: 400px; margin: 0 auto">
        <el-form-item label="订单类型">
          <el-select class="filter-item" clearable style="margin-right: 20px" v-model="temp.orderType" filterable
                     placeholder="请选择订单类型">
            <el-option
        ...
        <el-form-item label="供应商" v-if="temp.orderType === 'REPLENISH'">
          <page-select class="filter-item"
                       style="margin-right: 20px"
                       v-model="temp.orderType"
                       placeholder="请选择供应商"
                       :queryMethod="listSupplierInfo"/>
        </el-form-item>

        <el-form-item label="客户" v-if="temp.orderType === 'DISPATCH'">
          <el-select class="filter-item" clearable style="margin-right: 20px" v-model="temp.orderType" filterable
                     placeholder="请选择订单类型">
            <el-option
              v-for="item in orderTypes"
...
import {listSupplierInfo} from "@/api/info/supplier"; // secondary package based on el-pagination
